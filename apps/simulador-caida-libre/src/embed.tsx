...
const selectorHost = "[data-physikos-simulador-caida-libre]";
const host = document.querySelector<HTMLElement>(selectorHost);

if (!host) {
  console.error(
    `No se encontró el punto de montaje del simulador de caída libre: ${selectorHost}`,
  );
} else {
  ...
  raiz.id = "simulador-caida-libre-root";
