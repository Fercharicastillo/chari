...
const selectorHost = "[data-physikos-simulador-movimiento-parabolico]";
const host = document.querySelector<HTMLElement>(selectorHost);

if (!host) {
  console.error(
    `No se encontró el punto de montaje del simulador de movimiento parabólico: ${selectorHost}`,
  );
} else {
  ...
  raiz.id = "simulador-movimiento-parabolico-root";
